...
PFOS_GW_gdb = os.path.join(basepath, "PFOS_GW_Tests.gdb")
...
train_pts = os.path.join(testing_gdb, "PFOS_GW_training")
test_pts = os.path.join(testing_gdb, "PFOS_GW_testing")
test_bufs5mi = os.path.join(testing_gdb, "PFOS_GW_test_5mibuf")
...
for idx, row in IDW_params.iterrows():
    ...
    raster_path = os.path.join(PFOS_GW_gdb, out_name)
...
IDW_runs.to_csv(
    "C:/Duke/Year 2/MP/Interpolation_testing/PFOS_GW/IDW_t75Raster_Paths.csv", ","
)
...
IDW_runs_sorted.to_csv(
    "C:/Duke/Year 2/MP/Interpolation_testing/PFOS_GW/IDW_RankSorted.csv",
    ",",
)
...
for idx, row in UK_params.iterrows():
    ...
    out_var_raster = os.path.join(PFOS_GW_gdb, f"{out_name}_pdrs")
...
UK_runs.to_csv(
    "C:/Duke/Year 2/MP/Interpolation_testing/PFOS_GW/UK_t75Raster_Paths.csv", ","
)
...
UK_runs_sorted.to_csv(
    "C:/Duke/Year 2/MP/Interpolation_testing/PFOS_GW/UK_RankSorted.csv",
    ",",
)
...
##SAVE AS A CSV !!! SO YOU DON'T NEED TO RUN EVERYTHING AGAIN + WAIT 20 MIN
OK_runs.to_csv(
    "C:/Duke/Year 2/MP/Interpolation_testing/PFOS_GW/OK_t75Raster_Paths.csv", ","
)
...
OK_runs_sorted.to_csv(
    "C:/Duke/Year 2/MP/Interpolation_testing/PFOS_GW/OK_RankSorted.csv",
    ",",
)
